...
export default function Home() {
  ...
  return (
    <main
      id="home"
      className="min-h-screen w-full bg-[#0a0a0a] px-4 py-6 text-slate-100 sm:px-8 lg:px-16"
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-16">
        {/* Sticky navigation */}
        <header className="sticky top-0 z-40 mb-4 flex items-center justify-between gap-4 border-b border-slate-800/70 bg-[#050608]/90 px-3 py-3 backdrop-blur sm:px-4">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg border border-emerald-400/60 bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 text-xs font-mono font-semibold tracking-[0.18em] text-emerald-300 shadow-[0_0_18px_rgba(34,197,94,0.7)]">
              KA
            </div>
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full border border-slate-700 bg-slate-900/60 text-xs text-slate-300 shadow-sm transition hover:border-emerald-400 hover:text-emerald-300"
        ...
        <section className="grid gap-10 md:grid-cols-2 md:items-center animate-fade-in-up">
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center rounded-full border border-emerald-500/60 bg-black/60 px-3 py-1 text-[11px] font-mono text-emerald-300 shadow-[0_0_18px_rgba(34,197,94,0.7)]">
              <span className="mr-2 h-2 w-2 rounded-full bg-emerald-400 shadow-[0_0_10px_rgba(34,197,94,0.9)]" />
              <span>./keneni.sh</span>
            </div>
            <h1 className="text-3xl font-semibold leading-tight sm:text-4xl lg:text-5xl">
              <span className="block text-slate-200 font-mono text-sm uppercase tracking-[0.3em]">
                Hello, I&apos;m
              </span>
              <span className="mt-1 block text-4xl sm:text-5xl font-semibold text-emerald-400 drop-shadow-[0_0_25px_rgba(34,197,94,0.8)]">
                Keneni Asefa
              </span>
              <span className="mt-3 block font-mono text-sm sm:text-base text-slate-200">
                I&apos;m a{" "}
                <span className="inline-block min-w-[210px] rounded-md bg-emerald-500/10 px-2 py-1 text-emerald-300 shadow-[0_0_18px_rgba(34,197,94,0.5)] transition-colors">
                  {displayRole || "\u00a0"}
                </span>
              </span>
            </h1>
          ...
          <a
                ...
                className="rounded-full border border-emerald-500/40 bg-slate-900/50 px-6 py-2 text-sm font-medium text-emerald-300 backdrop-blur transition hover:border-emerald-400 hover:text-emerald-200"
              >
                Contact Me
              </a>
              <a
                ...
                className="rounded-full border border-cyan-400/60 bg-slate-900/40 px-6 py-2 text-sm font-medium text-cyan-200 backdrop-blur transition hover:border-cyan-300 hover:text-cyan-100"
              >
                Download CV
              </a>
            </div>
        ...
        <section className="mt-2 flex flex-wrap items-center justify-center gap-4 rounded-full border border-emerald-500/40 bg-black/60 px-6 py-3 text-[11px] font-mono text-slate-300 shadow-[0_0_25px_rgba(34,197,94,0.4)]">
          <div className="flex items-center gap-2">
        ...
        <section
          id="about"
          className="space-y-6 rounded-2xl border border-slate-800/80 bg-[#030504] p-6 sm:p-8 shadow-[0_0_35px_rgba(16,185,129,0.25)] animate-fade-in-up"
        >
          ...
          <div className="grid gap-5 lg:grid-cols-[1.2fr,minmax(0,1fr)]">
            {/* Bio */}
            <article className="rounded-2xl border border-emerald-500/40 bg-black/60 shadow-[0_0_30px_rgba(16,185,129,0.25)]">
              <div className="flex items-center justify-between border-b border-slate-800 px-4 py-2">
                <span className="font-mono text-[11px] text-emerald-300">./keneni/bio.sh</span>
              ...
              <span className="font-semibold text-emerald-300">
                ...
                <div className="flex flex-wrap gap-2 text-[11px]">
                  {["Security", "Pentesting", "Bug Bounties", "CTF Player"].map((tag) => (
                    <span
                      key={tag}
                      className="rounded-full border border-emerald-500/40 px-3 py-1 font-mono text-emerald-300"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              {/* Education */}
              <article className="rounded-2xl border border-cyan-500/40 bg-black/60 shadow-[0_0_30px_rgba(6,182,212,0.25)]">
                <div className="flex items-center justify-between border-b border-slate-800 px-4 py-2">
                  <span className="font-mono text-[11px] text-cyan-300">./keneni/education.sh</span>
            ...
            <div>
                    ...
                    <p className="font-semibold text-slate-100">Adama Science &amp; Technology University</p>
            ...
            <div>
              ...
              <article className="rounded-2xl border border-emerald-400/50 bg-black/60 shadow-[0_0_30px_rgba(34,197,94,0.25)]">
                <div className="flex items-center justify-between border-b border-slate-800 px-4 py-2">
                  <span className="font-mono text-[11px] text-emerald-300">./keneni/certs.sh</span>
                ...
                <div className="space-y-4 p-5 text-sm text-slate-300">
                  ...
                  <div className="space-y-3 text-[12px]">
                    {certifications.slice(0, 4).map((cert) => (
                      <div
                        key={cert}
                        className="rounded-lg border border-emerald-500/30 bg-slate-900/60 px-3 py-2 text-[11px] font-mono text-slate-200"
                      >
                        {cert}
              </div>
                    ))}
                    <div className="rounded-lg border border-emerald-500/30 bg-slate-900/60 px-3 py-2 text-[11px] font-mono text-slate-200">
          ...
          <ol className="relative space-y-6 border-l border-slate-800 pl-6">
            {experience.map((item) => (
              <li key={`${item.role}-${item.company}`} className="relative">
                ...
                <div className="rounded-xl border border-slate-800/70 bg-slate-950/70 p-4 sm:p-5">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {projects.map((project: ProjectItem) => (
              <article key={project.name} className="group">
                <div className="relative h-full transform rounded-xl border border-slate-800/80 bg-slate-950/70 p-5 shadow-[0_0_25px_rgba(15,23,42,0.9)] transition duration-500 [transform-style:preserve-3d] hover:-translate-y-1 hover:border-emerald-500/60 hover:bg-slate-900/80 hover:shadow-[0_0_40px_rgba(16,185,129,0.6)] hover:[transform:rotateY(6deg)]">
                  ...
                  <div className="mt-4 flex items-center justify-between text-[11px] font-mono">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-1 rounded-full border border-emerald-500/60 bg-slate-950/80 px-3 py-1 text-emerald-300 transition group-hover:border-emerald-400 group-hover:text-emerald-200"
                    >
                      <span>GitHub</span>
        ...
        <section
          id="skills"
          className="space-y-6 rounded-2xl border border-slate-800/80 bg-slate-950/70 p-6 sm:p-8 animate-fade-in-up"
        >
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="rounded-xl border border-cyan-400/50 bg-slate-950/70 px-4 py-2 text-[11px] font-mono text-cyan-200">
          ...
          <div className="relative z-10 rounded-2xl border border-slate-800/80 bg-black/70 p-6 shadow-[0_0_35px_rgba(16,185,129,0.25)]">
            <div className="grid gap-8 lg:grid-cols-2">
              <div className="space-y-4">
                ...
                <ul className="space-y-3 text-[11px] font-mono leading-relaxed text-slate-300">
                  <li>
                  ...
                  <li>
                    <span className="text-emerald-400 mr-2">▸</span>
                    <span className="font-semibold text-slate-100">Exploitation:</span>{" "}
                  ...
                  <li>
                    <span className="text-emerald-400 mr-2">▸</span>
                    <span className="font-semibold text-slate-100">Red Team Basics:</span>{" "}
              ...
              <div className="space-y-6">
                ...
                <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-emerald-500/40 bg-emerald-500/10 text-xl">
                  ...
                  <ul className="space-y-2 text-[11px] font-mono leading-relaxed text-slate-300">
                    <li>
                      <span className="text-emerald-400 mr-2">▸</span>
                      <span className="font-semibold text-slate-100">Languages:</span> Python, Bash, JavaScript, TypeScript, C++
                    </li>
                    <li>
                      <span className="text-emerald-400 mr-2">▸</span>
                      <span className="font-semibold text-slate-100">Automation &amp; APIs:</span> Python tooling, REST workflows, JSON handling
                    </li>
                    <li>
                      <span className="text-emerald-400 mr-2">▸</span>
                      <span className="font-semibold text-slate-100">
                ...
                <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-cyan-500/40 bg-cyan-500/10 text-xl">
                  ☁️
                    ...
                    <h3 className="text-sm font-mono uppercase tracking-[0.22em] text-cyan-300">
                  ...
                  <ul className="space-y-2 text-[11px] font-mono leading-relaxed text-slate-300">
                    <li>
                      ...
                      <span className="font-semibold text-slate-100">Cloud Platforms:</span> AWS (SS, EC2), Azure basics, Linux servers
                    </li>
                    <li>
                      <span className="text-cyan-400 mr-2">▸</span>
                      <span className="font-semibold text-slate-100">
                    ...
                    <li>
                      <span className="text-cyan-400 mr-2">▸</span>
                      <span className="font-semibold text-slate-100">Containers &amp; DevOps:</span>{" "}
        ...
        <section
          id="contact"
          className="mt-2 flex flex-col gap-6 rounded-2xl border border-slate-800/80 bg-slate-950/70 p-6 sm:flex-row sm:items-start sm:justify-between sm:p-8 animate-fade-in-up"
        >
          <div className="space-y-2">
            <p className="font-mono text-[10px] text-slate-500">
              ./Contact.sh
          ...
          <div className="flex w-full flex-col gap-4 text-sm text-slate-300 sm:flex-row">
            {/* Left: contact info window */}
            <div className="flex-1 rounded-xl border border-slate-800 bg-black/70 shadow-[0_0_30px_rgba(34,197,94,0.3)]">
              <div className="flex items-center justify-between border-b border-slate-800 px-4 py-2">
              ...
              >
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full rounded border border-slate-700 bg-black/60 px-3 py-2 text-xs text-slate-100 outline-none focus:border-emerald-400"
                  />
                </div>
                <div className="space-y-1">
                  <label
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full resize-none rounded border border-slate-700 bg-black/60 px-3 py-2 text-xs text-slate-100 outline-none focus:border-emerald-400"
                  />
                </div>
                <button
                  type="submit"
        ...
        {/* Footer */}
        <footer className="mt-4 flex flex-col items-center justify-between gap-2 border-t border-slate-800/80 py-4 text-[11px] text-slate-500 sm:flex-row">
